...
<html>
    <head>
        ...
        <title>manage GroupTravel</title>
        ...
        <script src="static/js/manageGroupTravel.js" type="text/javascript"></script>
                        ...
                        <c:forEach items="${allGroups}" var="aGroup">
                            <tr class="aUser">
                                ...
                                <td><button class="updatebutton" onclick="updateYourGroups(this)">Update</button>
                                    ...
                                    &nbsp;
                                    <button class="validbutton" onclick="validGroups(this)">Valid</button>
                                    &nbsp;
                                    <button class="banbutton" onclick="BanGroups(this)">Ban</button>
